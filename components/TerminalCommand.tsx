...
export interface TerminalCommandProps {
  /** The prompt text (e.g., "pavan@mainframe") */
  prompt?: string
    ...
    <div className={className}>
      ...
      <div className="mb-2">
        <div className="flex flex-wrap items-baseline text-sm md:text-base">
          ...
          <span className="text-secondary font-bold sm:hidden">pavan</span>
          ...
          <span
            className={`inline-block w-2 h-4 bg-secondary ml-0.5 align-middle transition-opacity duration-100 ${showCursor ? 'opacity-100' : 'opacity-0'
